...
out_male.saveAsTextFile("hdfs://antispam/user/hadoop/output/chencheng/crux/data/male/2016030518/")
out_female.saveAsTextFile("hdfs://antispam/user/hadoop/output/chencheng/crux/data/female/2016030518/")