...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/30/als_female_0310-19_004"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/female/2016032018_0310-19_004"  %(HDFS_OUTPUT_PATH) )
