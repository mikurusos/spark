...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/25/als_female_0311-14_003"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/parameters/female/25/2016031518_003"  %(HDFS_OUTPUT_PATH) )
sc.stop()