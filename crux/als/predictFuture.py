...
data = sc.textFile("%s/data/realdata/chengdu_result0322"  %(HDFS_OUTPUT_PATH) )
...
combins.saveAsTextFile("%s/results/female/chengdu_result0322_0310-21"  %(HDFS_OUTPUT_PATH) )
