...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/35/als_female_0310-14_003"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/parameters/female/35/2016031518_003_"  %(HDFS_OUTPUT_PATH) )
sc.stop()