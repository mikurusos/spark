...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/40/als_female_0310-19_003"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/female/2016032018_0310-19_003"  %(HDFS_OUTPUT_PATH) )
