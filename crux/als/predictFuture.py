...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/als_female_0311-14_30_100"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/parameters/female/2016031518_100"  %(HDFS_OUTPUT_PATH) )
sc.stop()