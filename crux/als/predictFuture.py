...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/30/als_female_0311-14_003"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/data/testSample/female/20160315-1618_results_als_female_0311-14_003"  %(HDFS_OUTPUT_PATH) )
