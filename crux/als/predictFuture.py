...
data = sc.textFile("%s/data/female/2016031018"  %(HDFS_OUTPUT_PATH) )

model = MatrixFactorizationModel.load(sc,"%s/model/als_female_0306-9"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/female/2016031018"  %(HDFS_OUTPUT_PATH) )
sc.stop()