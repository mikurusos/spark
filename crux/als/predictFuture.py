...
model = MatrixFactorizationModel.load(sc,"%s/model/als_female_parameters/als_female_0311-14_30_005"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/parameters/female/2016031518_005"  %(HDFS_OUTPUT_PATH) )
sc.stop()