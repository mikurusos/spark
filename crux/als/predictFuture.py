...
data = sc.textFile("hdfs://antispam/user/hadoop/output/chencheng/crux/data/male/2016030818")
...
combins.saveAsTextFile("hdfs://antispam/user/hadoop/output/chencheng/crux/results/male/2016030818")
sc.stop()