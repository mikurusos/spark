...
data = sc.textFile("%s/data/male/2016030918"  %(HDFS_OUTPUT_PATH) )

model = MatrixFactorizationModel.load(sc,"%s/model/als_male_0305-8"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/male/2016030918"  %(HDFS_OUTPUT_PATH) )
sc.stop()