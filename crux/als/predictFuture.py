...
data = sc.textFile("%s/data/male/2016030818"  %(HDFS_OUTPUT_PATH) )

model = MatrixFactorizationModel.load(sc,"%s/model/als_female_2-7"  %(HDFS_HOME_PATH))
...
combins.saveAsTextFile("%s/results/male/2016030818"  %(HDFS_OUTPUT_PATH) )
sc.stop()