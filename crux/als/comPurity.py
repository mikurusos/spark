...
data = sc.textFile("%s/results/parameters/female/2016031518_0001" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_dislike_0001', 'w') as f:
    for item in result:
