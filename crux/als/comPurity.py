...
data = sc.textFile("%s/results/male/2016031618" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_male_dislike_2016031618', 'w') as f:
    for item in result:
