...
data = sc.textFile("%s/results/female/2016032318_0310-22_003_40" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_female_dislike_2016032318_0310-22_40', 'w') as f:
    for item in result:
        if(result[item][1]):
