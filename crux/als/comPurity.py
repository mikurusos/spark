...
data = sc.textFile("%s/results/parameters/female/25/2016031518_003" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_dislike_003_25', 'w') as f:
    for item in result:
