...
data = sc.textFile("%s/results/male/2016032218_0317-21_003" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_male_dislike_2016032218_0317-21_003', 'w') as f:
    for item in result:
