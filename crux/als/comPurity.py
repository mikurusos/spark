...
data = sc.textFile("%s/results/parameters/female/25/2016031518_003_" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_dislike_003_25_', 'w') as f:
    for item in result:
