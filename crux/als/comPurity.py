...
data = sc.textFile("%s/results/female/2016032018_0310-19_002" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_female_dislike_2016032018_0310-19_002', 'w') as f:
    for item in result:
