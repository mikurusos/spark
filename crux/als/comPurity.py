...
data = sc.textFile("%s/results/female/2016031918_13-19" % (HDFS_OUTPUT_PATH))
...
with open('/home/hadoop/chen.cheng/Chronos/parameters/AUC_purity_female_dislike_2016031918_13-19', 'w') as f:
    for item in result:
